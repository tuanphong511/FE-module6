...
export default function DetailHouse() {
    ...
    return (
        <div className="row">
            ...
            <div className="col-12 mt-4" style={{ padding: "0 80px", display: "flex" }}>
                <div className="col-8">
                    <div style={{ display: "flex" }}>
                ...
                <div className="col-4">
                    <div style={{ width: "390", height: "480px", border: "0.5px solid gray", borderRadius: "10px", padding: "24px", boxShadow: "1px 2px 9px #DADADA" }}>
